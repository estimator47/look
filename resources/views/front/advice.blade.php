...
@section('main')
    ...
    <main id="main">
        <!-- PAGE TITLE -->
        <div id="page-title">
            <h1><span>{{ __('message.usefultips') }}</span></h1>
        </div>
        <!-- PAGE CONTAINER -->
                        ...
                        @foreach($tips as $new)
                            <!-- POST 1 -->
                                <article class="grid-container">
                                    <div class="grid-img">
                                        <a href="{{url('/single_tips', [$new->id])}}" class="gallery link">
                                    ...
                                    <div class="grid-content">
                                        ...
                                        <h4>
                                            <a href="{{url('/single_tips', [$new->id])}}" style="color: #1a2226;">@if(App::isLocale('ru')) {{{$new->title_ru}}} @else  {{$new->title_uz}} @endif</a>
                                        </h4>
                                    </div>
                                </article>
                            @endforeach
